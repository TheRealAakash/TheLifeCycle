...
def preprocess(data):  # step 3
    data = (data * 2. / 255 - 1).reshape((len(data), settings.IMG_H, settings.IMG_W, settings.CHANNELS))  # pixel values in range [-1., 1.] for D
    return data
    # Sample images after greyscali
...
class KerasModel:
    ...
    def build_model(self):
        ...
        model.add(Dense(self.n_out, activation='softmax'))
...
if __name__ == '__main__':
    wandb.init(project='TheLifeCycle', entity='therealaakash', config=configs)
    main()
